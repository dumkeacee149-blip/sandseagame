...
def add_limbs(builder):
    ...
    for side, sx in (("left", -1), ("right", 1)):
        builder.add_box((0.30, 0.34, 0.23), (sx * 0.58, 0.0, 1.78), "teal", f"{side}_upper_arm")
    ...
    builder.add_box((0.16, 0.06, 1.02), (0.96, -0.34, 1.32), "bone", "right_forearm", rotation=(0.16, 0.0, -0.10))
    builder.add_box((0.06, 0.045, 1.03), (1.04, -0.355, 1.32), "iron", "right_forearm", rotation=(0.16, 0.0, -0.10))
...
def build_actions(armature):
    ...
    walk_a = {
        "left_thigh": (0.34, 0.0, 0.0),
        "left_shin": (-0.16, 0.0, 0.0),
        "right_thigh": (-0.34, 0.0, 0.0),
        "right_shin": (0.20, 0.0, 0.0),
        "left_upper_arm": (-0.20, 0.0, 0.0),
        "right_upper_arm": (0.20, 0.0, 0.0),
        "spine": (0.02, 0.0, 0.025),
    }
    walk_b = {
        "left_thigh": (-0.34, 0.0, 0.0),
        "left_shin": (0.20, 0.0, 0.0),
        "right_thigh": (0.34, 0.0, 0.0),
        "right_shin": (-0.16, 0.0, 0.0),
        "left_upper_arm": (0.20, 0.0, 0.0),
        "right_upper_arm": (-0.20, 0.0, 0.0),
        "spine": (0.02, 0.0, -0.025),
    }
    create_action(
        ...
        "Walk",
        [
            (1, walk_a, {"root": (0.0, 0.0, 0.015), "left_thigh": (0.0, -0.035, 0.0), "right_thigh": (0.0, 0.035, 0.0)}),
            (13, {}, {"root": (0.0, 0.0, 0.045)}),
            (25, walk_b, {"root": (0.0, 0.0, 0.015), "left_thigh": (0.0, 0.035, 0.0), "right_thigh": (0.0, -0.035, 0.0)}),
            (37, {}, {"root": (0.0, 0.0, 0.045)}),
            (49, walk_a, {"root": (0.0, 0.0, 0.015), "left_thigh": (0.0, -0.035, 0.0), "right_thigh": (0.0, 0.035, 0.0)}),
        ],
    )

    run_a = {
        "spine": (0.11, 0.0, 0.03),
        "left_thigh": (0.58, 0.0, 0.0),
        "left_shin": (-0.30, 0.0, 0.0),
        "right_thigh": (-0.52, 0.0, 0.0),
        "right_shin": (0.34, 0.0, 0.0),
        "left_upper_arm": (-0.38, 0.0, 0.0),
        "right_upper_arm": (0.38, 0.0, 0.0),
    }
    run_b = {
        "spine": (0.11, 0.0, -0.03),
        "left_thigh": (-0.52, 0.0, 0.0),
        "left_shin": (0.34, 0.0, 0.0),
        "right_thigh": (0.58, 0.0, 0.0),
        "right_shin": (-0.30, 0.0, 0.0),
        "left_upper_arm": (0.38, 0.0, 0.0),
        "right_upper_arm": (-0.38, 0.0, 0.0),
    }
    create_action(
        ...
        "Run",
        [
            (1, run_a, {"root": (0.0, 0.0, 0.035), "left_thigh": (0.0, -0.055, 0.0), "right_thigh": (0.0, 0.055, 0.0)}),
            (9, {}, {"root": (0.0, 0.0, 0.08)}),
            (17, run_b, {"root": (0.0, 0.0, 0.035), "left_thigh": (0.0, 0.055, 0.0), "right_thigh": (0.0, -0.055, 0.0)}),
            (25, {}, {"root": (0.0, 0.0, 0.08)}),
            (33, run_a, {"root": (0.0, 0.0, 0.035), "left_thigh": (0.0, -0.055, 0.0), "right_thigh": (0.0, 0.055, 0.0)}),
        ],
    )
